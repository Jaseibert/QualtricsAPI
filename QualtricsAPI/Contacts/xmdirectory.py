...
class XMDirectory(Credentials):
    ...
    def delete_contact(self, contact_id=None):
        ...
        '''
        assert len(mailing_list) == 19, 'Hey, the parameter for "contact_id" that was passed is the wrong length. It should have 19 characters.'
        assert mailing_list[:4] == 'CID_', 'Hey there! It looks like the Contact ID that was entered is incorrect. Please try again.'
