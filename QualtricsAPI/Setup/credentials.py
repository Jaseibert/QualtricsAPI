...
class Credentials(object):
    ...
    def header_setup(self,content_type=False,responses=True, distributions=False):
        ...
        path = 'directories/{0}/'.format(os.environ['directory_id'])
        if responses == True:
            path = 'responseexports/'
        elif distributions == True:
            path = 'distributions'
