...
class setup_tests(object):
    ...
    def setup_test_survey_id(self, short=False, false_id=False):
        ...
        survey_id = 'SV_ThisIsaFakeID!' if short else 'SV_ThisIsaFakeSurveyID!'
    ...
    def setup_test_library_id_ur(self, short=False, false_id=False):
        ...
        lib_id = 'UR_ThisIsaFakeID!' if short else 'UR_ThisIsaFakeLibraryID!'
    ...
    def setup_test_library_id_gr(self, short=False, false_id=False):
        ...
        lib_id = 'GR_ThisIsaFakeID!' if short else 'GR_ThisIsaFakeLibraryID!'
    ...
    def setup_test_dist_id(self, short=False, false_id=False):
        ...
        dist_id = 'EMD_ThisIsaFakeID!' if short else 'EMD_ThisIsaFakeDistributionID!'
    ...
    def setup_test_message_id(self, short=False, false_id=False):
        ...
        msg_id = 'MS_ThisIsaFakeID!' if short else 'MS_ThisIsaFakeMessageID!'
